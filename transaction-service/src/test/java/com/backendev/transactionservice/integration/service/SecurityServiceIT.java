...
class SecurityServiceIT {
    ...
    void shouldThrowException_WhenNoAuthenticationFound() {
        ...
        Assertions.assertThatThrownBy(() -> securityService.getCurrentUserId())
    ...
    void shouldThrowException_WhenClaimsNotFound() {
        ...
        Assertions.assertThatThrownBy(() -> securityService.getCurrentUserEmail())
                .isInstanceOf(IllegalStateException.class)
    ...
    void shouldThrowException_WhenGetRolesAndNoAuthentication() {
        ...
        Assertions.assertThatThrownBy(() -> securityService.getCurrentUserRoles())
                .isInstanceOf(IllegalStateException.class)
                .hasMessage("No authenticated user found");
    }
